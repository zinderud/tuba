...
{
    public class TBL_BANKA_BAKIYEMap : EntityTypeConfiguration<TBL_BANKA_BAKIYE>
    {
        public TBL_BANKA_BAKIYEMap()
        {
            // Primary Key
            this.HasKey(t => t.TBL_BANKA_BAKIYE_ID);
            ...
            this.ToTable("TBL_BANKA_BAKIYE");
            this.Property(t => t.TBL_BANKA_BAKIYE_ID).HasColumnName("TBL_BANKA_BAKIYE_ID");
            ...
            // Relationships
            this.HasOptional(t => t.TBL_BANKA)
                .WithMany(t => t.TBL_BANKA_BAKIYE)
                .HasForeignKey(d => d.TBL_BANKA_ID);
