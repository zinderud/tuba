...
{ 
	...
	public  static partial class  TBL_SPARISMaping   
    {
        ...
        /// </summary>
        /// <param name="dto"><see cref="TBL_SPARISDTO"/> converted from <see cref="TBL_SPARIS"/>.</param>
		static partial void OnDTO(this TBL_SPARIS entity, TBL_SPARISDTO dto);
		/// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="TBL_SPARIS"/> converted from <see cref="TBL_SPARISDTO"/>.</param>
		static partial void OnEntity(this TBL_SPARISDTO dto, TBL_SPARIS  entity);
		/// <summary>
        ...
        /// <param name="dto"><see cref="TBL_SPARISDTO"/> to convert.</param>
         public static TBL_SPARIS    ToEntity(this TBL_SPARISDTO dto)
        {
            if (dto == null) return null; 
            var entity = new TBL_SPARIS(); 
		...
		/// <summary>
        /// Converts this instance of <see cref="TBL_SPARIS"/> to an instance of <see cref="TBL_SPARISDTO"/>.
        /// </summary>
        /// <param name="entity"><see cref="TBL_SPARIS"/> to convert.</param>
		  public static TBL_SPARISDTO ToDTO(this TBL_SPARIS entity)
        {
 ...
 //EdmProperty
        ...
        /// <returns></returns>
		 public static List<TBL_SPARIS> ToEntities(this IEnumerable<TBL_SPARISDTO> dtos)
        {
		 ...
		 /// <summary>
        /// Converts each instance of <see cref="TBL_SPARIS"/> to an instance of <see cref="TBL_SPARISDTO"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
		 public static List<TBL_SPARISDTO> ToDTOs(this IEnumerable<TBL_SPARIS> entities)
        {
