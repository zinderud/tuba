...
{ 
	...
	public  static partial class  TBL_PERSONELMaping   
    {
        ...
        /// </summary>
        /// <param name="dto"><see cref="TBL_PERSONELDTO"/> converted from <see cref="TBL_PERSONEL"/>.</param>
		static partial void OnDTO(this TBL_PERSONEL entity, TBL_PERSONELDTO dto);
		/// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="TBL_PERSONEL"/> converted from <see cref="TBL_PERSONELDTO"/>.</param>
		static partial void OnEntity(this TBL_PERSONELDTO dto, TBL_PERSONEL  entity);
		/// <summary>
        ...
        /// <param name="dto"><see cref="TBL_PERSONELDTO"/> to convert.</param>
         public static TBL_PERSONEL    ToEntity(this TBL_PERSONELDTO dto)
        {
            if (dto == null) return null; 
            var entity = new TBL_PERSONEL(); 
		...
		/// <summary>
        /// Converts this instance of <see cref="TBL_PERSONEL"/> to an instance of <see cref="TBL_PERSONELDTO"/>.
        /// </summary>
        /// <param name="entity"><see cref="TBL_PERSONEL"/> to convert.</param>
		  public static TBL_PERSONELDTO ToDTO(this TBL_PERSONEL entity)
        {
 ...
 //EdmProperty
        ...
        /// <returns></returns>
		 public static List<TBL_PERSONEL> ToEntities(this IEnumerable<TBL_PERSONELDTO> dtos)
        {
		 ...
		 /// <summary>
        /// Converts each instance of <see cref="TBL_PERSONEL"/> to an instance of <see cref="TBL_PERSONELDTO"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
		 public static List<TBL_PERSONELDTO> ToDTOs(this IEnumerable<TBL_PERSONEL> entities)
        {
