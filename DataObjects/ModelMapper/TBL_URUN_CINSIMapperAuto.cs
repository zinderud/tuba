...
{ 
	...
	public  static partial class  TBL_URUN_CINSIMaping   
    {
        ...
        /// </summary>
        /// <param name="dto"><see cref="TBL_URUN_CINSIDTO"/> converted from <see cref="TBL_URUN_CINSI"/>.</param>
		static partial void OnDTO(this TBL_URUN_CINSI entity, TBL_URUN_CINSIDTO dto);
		/// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="TBL_URUN_CINSI"/> converted from <see cref="TBL_URUN_CINSIDTO"/>.</param>
		static partial void OnEntity(this TBL_URUN_CINSIDTO dto, TBL_URUN_CINSI  entity);
		/// <summary>
        ...
        /// <param name="dto"><see cref="TBL_URUN_CINSIDTO"/> to convert.</param>
         public static TBL_URUN_CINSI    ToEntity(this TBL_URUN_CINSIDTO dto)
        {
            if (dto == null) return null; 
            var entity = new TBL_URUN_CINSI(); 
		...
		/// <summary>
        /// Converts this instance of <see cref="TBL_URUN_CINSI"/> to an instance of <see cref="TBL_URUN_CINSIDTO"/>.
        /// </summary>
        /// <param name="entity"><see cref="TBL_URUN_CINSI"/> to convert.</param>
		  public static TBL_URUN_CINSIDTO ToDTO(this TBL_URUN_CINSI entity)
        {
 ...
 //EdmProperty
        ...
        /// <returns></returns>
		 public static List<TBL_URUN_CINSI> ToEntities(this IEnumerable<TBL_URUN_CINSIDTO> dtos)
        {
		 ...
		 /// <summary>
        /// Converts each instance of <see cref="TBL_URUN_CINSI"/> to an instance of <see cref="TBL_URUN_CINSIDTO"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
		 public static List<TBL_URUN_CINSIDTO> ToDTOs(this IEnumerable<TBL_URUN_CINSI> entities)
        {
