...
{ 
	...
	public  static partial class  TBL_BANKAMaping   
    {
        ...
        /// </summary>
        /// <param name="dto"><see cref="TBL_BANKADTO"/> converted from <see cref="TBL_BANKA"/>.</param>
		static partial void OnDTO(this TBL_BANKA entity, TBL_BANKADTO dto);
		/// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="TBL_BANKA"/> converted from <see cref="TBL_BANKADTO"/>.</param>
		static partial void OnEntity(this TBL_BANKADTO dto, TBL_BANKA  entity);
		/// <summary>
        ...
        /// <param name="dto"><see cref="TBL_BANKADTO"/> to convert.</param>
         public static TBL_BANKA    ToEntity(this TBL_BANKADTO dto)
        {
            if (dto == null) return null; 
            var entity = new TBL_BANKA(); 
		...
		/// <summary>
        /// Converts this instance of <see cref="TBL_BANKA"/> to an instance of <see cref="TBL_BANKADTO"/>.
        /// </summary>
        /// <param name="entity"><see cref="TBL_BANKA"/> to convert.</param>
		  public static TBL_BANKADTO ToDTO(this TBL_BANKA entity)
        {
 ...
 //EdmProperty
        ...
        /// <returns></returns>
		 public static List<TBL_BANKA> ToEntities(this IEnumerable<TBL_BANKADTO> dtos)
        {
		 ...
		 /// <summary>
        /// Converts each instance of <see cref="TBL_BANKA"/> to an instance of <see cref="TBL_BANKADTO"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
		 public static List<TBL_BANKADTO> ToDTOs(this IEnumerable<TBL_BANKA> entities)
        {
