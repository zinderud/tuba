...
{ 
	...
	public  static partial class  TBL_URUN_FATURAMaping   
    {
        ...
        /// </summary>
        /// <param name="dto"><see cref="TBL_URUN_FATURADTO"/> converted from <see cref="TBL_URUN_FATURA"/>.</param>
		static partial void OnDTO(this TBL_URUN_FATURA entity, TBL_URUN_FATURADTO dto);
		/// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="TBL_URUN_FATURA"/> converted from <see cref="TBL_URUN_FATURADTO"/>.</param>
		static partial void OnEntity(this TBL_URUN_FATURADTO dto, TBL_URUN_FATURA  entity);
		/// <summary>
        ...
        /// <param name="dto"><see cref="TBL_URUN_FATURADTO"/> to convert.</param>
         public static TBL_URUN_FATURA    ToEntity(this TBL_URUN_FATURADTO dto)
        {
            if (dto == null) return null; 
            var entity = new TBL_URUN_FATURA(); 
		...
		/// <summary>
        /// Converts this instance of <see cref="TBL_URUN_FATURA"/> to an instance of <see cref="TBL_URUN_FATURADTO"/>.
        /// </summary>
        /// <param name="entity"><see cref="TBL_URUN_FATURA"/> to convert.</param>
		  public static TBL_URUN_FATURADTO ToDTO(this TBL_URUN_FATURA entity)
        {
 ...
 //EdmProperty
        ...
        /// <returns></returns>
		 public static List<TBL_URUN_FATURA> ToEntities(this IEnumerable<TBL_URUN_FATURADTO> dtos)
        {
		 ...
		 /// <summary>
        /// Converts each instance of <see cref="TBL_URUN_FATURA"/> to an instance of <see cref="TBL_URUN_FATURADTO"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
		 public static List<TBL_URUN_FATURADTO> ToDTOs(this IEnumerable<TBL_URUN_FATURA> entities)
        {
