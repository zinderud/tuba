...
namespace AutoBusinessObjects
{
    ...
    public partial class TBL_BANKA_BAKIYEDTO 
    {
    	
     	[DataMember]
        public int TBL_BANKA_BAKIYE_ID { get { return _tBL_BANKA_BAKIYE_ID; } set { if (!Equals(value, _tBL_BANKA_BAKIYE_ID)) { _tBL_BANKA_BAKIYE_ID = value; } } }
    	private int _tBL_BANKA_BAKIYE_ID;
    
    	
     	[DataMember]
        public Nullable<int> TBL_BANKA_ID { get { return _tBL_BANKA_ID; } set { if (!Equals(value, _tBL_BANKA_ID)) { _tBL_BANKA_ID = value; } } }
