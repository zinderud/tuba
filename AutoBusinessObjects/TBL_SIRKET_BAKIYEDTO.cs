...
namespace AutoBusinessObjects
{
    ...
    public partial class TBL_SIRKET_BAKIYEDTO 
    {
    	
     	[DataMember]
        public int TBL_SIRKET_BAKIYE_ID { get { return _tBL_SIRKET_BAKIYE_ID; } set { if (!Equals(value, _tBL_SIRKET_BAKIYE_ID)) { _tBL_SIRKET_BAKIYE_ID = value; } } }
