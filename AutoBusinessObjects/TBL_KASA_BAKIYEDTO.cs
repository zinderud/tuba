...
namespace AutoBusinessObjects
{
    ...
    public partial class TBL_KASA_BAKIYEDTO 
    {
    	
     	[DataMember]
        public int TBL_KASA_BAKIYE_ID { get { return _tBL_KASA_BAKIYE_ID; } set { if (!Equals(value, _tBL_KASA_BAKIYE_ID)) { _tBL_KASA_BAKIYE_ID = value; } } }
