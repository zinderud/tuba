...
namespace AnaEkran.Models
{
    ...
    public partial class TBL_KASA_BAKIYE_MODEL  :ModelBase<TBL_KASA_BAKIYE_MODEL>
    {
    	 
        public  int  TBL_KASA_BAKIYE_ID { get { return _tBL_KASA_BAKIYE_ID; } set { if (!Equals(value, _tBL_KASA_BAKIYE_ID)) { _tBL_KASA_BAKIYE_ID = value;  NotifyPropertyChanged(m=>m.TBL_KASA_BAKIYE_ID);} } }
    	private  int  _tBL_KASA_BAKIYE_ID;
