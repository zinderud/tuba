...
namespace AnaEkran.Models
{
    ...
    public partial class TBL_GIDER_BAKIYE_MODEL  :ModelBase<TBL_GIDER_BAKIYE_MODEL>
    {
    	 
        public  int  TBL_GIDER_BAKIYE_ID { get { return _tBL_GIDER_BAKIYE_ID; } set { if (!Equals(value, _tBL_GIDER_BAKIYE_ID)) { _tBL_GIDER_BAKIYE_ID = value;  NotifyPropertyChanged(m=>m.TBL_GIDER_BAKIYE_ID);} } }
    	private  int  _tBL_GIDER_BAKIYE_ID;
    
    	 
        public Nullable<int> TBL_GIDER_ID { get { return _tBL_GIDER_ID; } set { if (!Equals(value, _tBL_GIDER_ID)) { _tBL_GIDER_ID = value;  NotifyPropertyChanged(m=>m.TBL_GIDER_ID);} } }
