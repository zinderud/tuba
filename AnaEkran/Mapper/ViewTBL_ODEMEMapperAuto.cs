...
{ 
	...
	public  static partial class  TBL_ODEMEMaping   
    {
        ...
        /// </summary>
        /// <param name="dto"><see cref="TBL_ODEMEDTO"/> converted from <see cref="TBL_ODEME_MODEL"/>.</param>
		static partial void OnDTO(this TBL_ODEME_MODEL entity, TBL_ODEMEDTO dto);
		/// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="TBL_ODEME_MODEL"/> converted from <see cref="TBL_ODEMEDTO"/>.</param>
		static partial void OnEntity(this TBL_ODEMEDTO dto, TBL_ODEME_MODEL  entity);
		/// <summary>
        ...
        /// <param name="dto"><see cref="TBL_ODEMEDTO"/> to convert.</param>
         public static TBL_ODEME_MODEL    ToEntity(this TBL_ODEMEDTO dto)
        {
            if (dto == null) return null; 
            var entity = new TBL_ODEME_MODEL(); 
		...
		/// <summary>
        /// Converts this instance of <see cref="TBL_ODEME_MODEL"/> to an instance of <see cref="TBL_ODEMEDTO"/>.
        /// </summary>
        /// <param name="entity"><see cref="TBL_ODEME"/> to convert.</param>
		  public static TBL_ODEMEDTO ToDTO(this TBL_ODEME_MODEL entity)
        {
        ...
        /// <returns></returns>
		 public static List<TBL_ODEME_MODEL> ToEntities(this IEnumerable<TBL_ODEMEDTO> dtos)
        {
		 ...
		 /// <summary>
        /// Converts each instance of <see cref="TBL_ODEME_MODEL"/> to an instance of <see cref="TBL_ODEMEDTO"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
		 public static List<TBL_ODEMEDTO> ToDTOs(this IEnumerable<TBL_ODEME_MODEL> entities)
        {
