...
{ 
	...
	public  static partial class  TBL_DEPO_ISLEMMaping   
    {
        ...
        /// </summary>
        /// <param name="dto"><see cref="TBL_DEPO_ISLEMDTO"/> converted from <see cref="TBL_DEPO_ISLEM_MODEL"/>.</param>
		static partial void OnDTO(this TBL_DEPO_ISLEM_MODEL entity, TBL_DEPO_ISLEMDTO dto);
		/// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="TBL_DEPO_ISLEM_MODEL"/> converted from <see cref="TBL_DEPO_ISLEMDTO"/>.</param>
		static partial void OnEntity(this TBL_DEPO_ISLEMDTO dto, TBL_DEPO_ISLEM_MODEL  entity);
		/// <summary>
        ...
        /// <param name="dto"><see cref="TBL_DEPO_ISLEMDTO"/> to convert.</param>
         public static TBL_DEPO_ISLEM_MODEL    ToEntity(this TBL_DEPO_ISLEMDTO dto)
        {
            if (dto == null) return null; 
            var entity = new TBL_DEPO_ISLEM_MODEL(); 
		...
		/// <summary>
        /// Converts this instance of <see cref="TBL_DEPO_ISLEM_MODEL"/> to an instance of <see cref="TBL_DEPO_ISLEMDTO"/>.
        /// </summary>
        /// <param name="entity"><see cref="TBL_DEPO_ISLEM"/> to convert.</param>
		  public static TBL_DEPO_ISLEMDTO ToDTO(this TBL_DEPO_ISLEM_MODEL entity)
        {
        ...
        /// <returns></returns>
		 public static List<TBL_DEPO_ISLEM_MODEL> ToEntities(this IEnumerable<TBL_DEPO_ISLEMDTO> dtos)
        {
		 ...
		 /// <summary>
        /// Converts each instance of <see cref="TBL_DEPO_ISLEM_MODEL"/> to an instance of <see cref="TBL_DEPO_ISLEMDTO"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
		 public static List<TBL_DEPO_ISLEMDTO> ToDTOs(this IEnumerable<TBL_DEPO_ISLEM_MODEL> entities)
        {
