...
{ 
	...
	public  static partial class  TBL_DEPO_TRANSFERMaping   
    {
        ...
        /// </summary>
        /// <param name="dto"><see cref="TBL_DEPO_TRANSFERDTO"/> converted from <see cref="TBL_DEPO_TRANSFER_MODEL"/>.</param>
		static partial void OnDTO(this TBL_DEPO_TRANSFER_MODEL entity, TBL_DEPO_TRANSFERDTO dto);
		/// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="TBL_DEPO_TRANSFER_MODEL"/> converted from <see cref="TBL_DEPO_TRANSFERDTO"/>.</param>
		static partial void OnEntity(this TBL_DEPO_TRANSFERDTO dto, TBL_DEPO_TRANSFER_MODEL  entity);
		/// <summary>
        ...
        /// <param name="dto"><see cref="TBL_DEPO_TRANSFERDTO"/> to convert.</param>
         public static TBL_DEPO_TRANSFER_MODEL    ToEntity(this TBL_DEPO_TRANSFERDTO dto)
        {
            if (dto == null) return null; 
            var entity = new TBL_DEPO_TRANSFER_MODEL(); 
		...
		/// <summary>
        /// Converts this instance of <see cref="TBL_DEPO_TRANSFER_MODEL"/> to an instance of <see cref="TBL_DEPO_TRANSFERDTO"/>.
        /// </summary>
        /// <param name="entity"><see cref="TBL_DEPO_TRANSFER"/> to convert.</param>
		  public static TBL_DEPO_TRANSFERDTO ToDTO(this TBL_DEPO_TRANSFER_MODEL entity)
        {
        ...
        /// <returns></returns>
		 public static List<TBL_DEPO_TRANSFER_MODEL> ToEntities(this IEnumerable<TBL_DEPO_TRANSFERDTO> dtos)
        {
		 ...
		 /// <summary>
        /// Converts each instance of <see cref="TBL_DEPO_TRANSFER_MODEL"/> to an instance of <see cref="TBL_DEPO_TRANSFERDTO"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
		 public static List<TBL_DEPO_TRANSFERDTO> ToDTOs(this IEnumerable<TBL_DEPO_TRANSFER_MODEL> entities)
        {
