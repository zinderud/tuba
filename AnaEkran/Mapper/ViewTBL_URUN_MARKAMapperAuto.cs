...
{ 
	...
	public  static partial class  TBL_URUN_MARKAMaping   
    {
        ...
        /// </summary>
        /// <param name="dto"><see cref="TBL_URUN_MARKADTO"/> converted from <see cref="TBL_URUN_MARKA_MODEL"/>.</param>
		static partial void OnDTO(this TBL_URUN_MARKA_MODEL entity, TBL_URUN_MARKADTO dto);
		/// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="TBL_URUN_MARKA_MODEL"/> converted from <see cref="TBL_URUN_MARKADTO"/>.</param>
		static partial void OnEntity(this TBL_URUN_MARKADTO dto, TBL_URUN_MARKA_MODEL  entity);
		/// <summary>
        ...
        /// <param name="dto"><see cref="TBL_URUN_MARKADTO"/> to convert.</param>
         public static TBL_URUN_MARKA_MODEL    ToEntity(this TBL_URUN_MARKADTO dto)
        {
            if (dto == null) return null; 
            var entity = new TBL_URUN_MARKA_MODEL(); 
		...
		/// <summary>
        /// Converts this instance of <see cref="TBL_URUN_MARKA_MODEL"/> to an instance of <see cref="TBL_URUN_MARKADTO"/>.
        /// </summary>
        /// <param name="entity"><see cref="TBL_URUN_MARKA"/> to convert.</param>
		  public static TBL_URUN_MARKADTO ToDTO(this TBL_URUN_MARKA_MODEL entity)
        {
        ...
        /// <returns></returns>
		 public static List<TBL_URUN_MARKA_MODEL> ToEntities(this IEnumerable<TBL_URUN_MARKADTO> dtos)
        {
		 ...
		 /// <summary>
        /// Converts each instance of <see cref="TBL_URUN_MARKA_MODEL"/> to an instance of <see cref="TBL_URUN_MARKADTO"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
		 public static List<TBL_URUN_MARKADTO> ToDTOs(this IEnumerable<TBL_URUN_MARKA_MODEL> entities)
        {
