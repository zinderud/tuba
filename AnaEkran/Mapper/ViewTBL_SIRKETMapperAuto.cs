...
{ 
	...
	public  static partial class  TBL_SIRKETMaping   
    {
        ...
        /// </summary>
        /// <param name="dto"><see cref="TBL_SIRKETDTO"/> converted from <see cref="TBL_SIRKET_MODEL"/>.</param>
		static partial void OnDTO(this TBL_SIRKET_MODEL entity, TBL_SIRKETDTO dto);
		/// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="TBL_SIRKET_MODEL"/> converted from <see cref="TBL_SIRKETDTO"/>.</param>
		static partial void OnEntity(this TBL_SIRKETDTO dto, TBL_SIRKET_MODEL  entity);
		/// <summary>
        ...
        /// <param name="dto"><see cref="TBL_SIRKETDTO"/> to convert.</param>
         public static TBL_SIRKET_MODEL    ToEntity(this TBL_SIRKETDTO dto)
        {
            if (dto == null) return null; 
            var entity = new TBL_SIRKET_MODEL(); 
		...
		/// <summary>
        /// Converts this instance of <see cref="TBL_SIRKET_MODEL"/> to an instance of <see cref="TBL_SIRKETDTO"/>.
        /// </summary>
        /// <param name="entity"><see cref="TBL_SIRKET"/> to convert.</param>
		  public static TBL_SIRKETDTO ToDTO(this TBL_SIRKET_MODEL entity)
        {
        ...
        /// <returns></returns>
		 public static List<TBL_SIRKET_MODEL> ToEntities(this IEnumerable<TBL_SIRKETDTO> dtos)
        {
		 ...
		 /// <summary>
        /// Converts each instance of <see cref="TBL_SIRKET_MODEL"/> to an instance of <see cref="TBL_SIRKETDTO"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
		 public static List<TBL_SIRKETDTO> ToDTOs(this IEnumerable<TBL_SIRKET_MODEL> entities)
        {
